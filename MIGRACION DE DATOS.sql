...
-- Trabajo
CREATE TABLE empleados_mayores_55
(cedula NUMBER PRIMARY KEY,
nombre VARCHAR2(50) NOT NULL,
edad NUMBER);
...
INTO empleados_mujeres VALUES (CED,NOM,SAL)
WHEN ED > 65 THEN
INTO empleados_mayores_55 VALUES (CED,NOM,ED)
SELECT cedula CED, nombre NOM, edad ED, sueldo SAL, sexo SX
FROM empleados;

delete empleados_mujeres;
delete empleados_menores_40;
SELECT * FROM empleados_mayores_55;
